...
const AdminDashboard = () => {
  ...
  return (
    <div className='min-h-screen p-12 bg-gray-100 py-6 flex flex-col justify-center sm:py-12'>
      <div className='relative py-3 max-h-96 sm:max-w-xl md:max-w-full sm:mx-auto'>
