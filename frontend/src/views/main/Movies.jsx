                ...
                <div className="container p-5 mx-auto">
                    ...
                    {isModalOpen && (
                        <div className="fixed inset-0 z-50 flex items-center justify-center" onClick={handleModalClose}>
                            ...
                            <div className="bg-white rounded-lg shadow-lg z-10 overflow-y-auto sm:w-8/12 lg:w-9/12 w-11/12" onClick={handleModalClose}>
                                <div className="p-4">
                                    ...
                                    <MovieDetailsCard movie={selectedMovie} onClose={handleModalClose} loadStatus={loadStatus} />
                                </div>
                            </div>
                        </div>
                    )}
