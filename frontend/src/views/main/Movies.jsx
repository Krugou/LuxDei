...
const Movies = () => {
  // State for storing movie data and handling selection
  const [movies, setMovies] = useState([]);
  const [selectedMovie, setSelectedMovie] = useState(null);

  // State for handling search functionality, modal visibility, and loading status
  ...
  // Handle movie selection and opening the details modal
        ...
        <div className='container bg-gray-100 p-5 mx-auto'>
          ...
          {isModalOpen && (
            <div className='fixed inset-0 z-50 flex items-center justify-center'>
              ...
              <div className='bg-white rounded-lg shadow-lg z-10 overflow-y-auto sm:w-8/12 lg:w-9/12 xl:w-8/12 w-11/12'>
                <div className='p-4'>
                  <button
